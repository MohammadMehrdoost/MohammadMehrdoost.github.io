...
<div id="details" style="background: #fff;box-shadow: 0 1px 3px #eee;">
    <div class="right">
        ...
        <div class="gallery">
            ...
            <img id="zoomproduct" src="public/images/products/<?= $productInfo['id'] ?>/product_350.jpg" data-zoom-image="public/images/products/<?= $productInfo['id'] ?>/product.jpg">
            ...
            <ul>
                ...
                ?>
                        ...
                        <li data-main-image="public/images/products/<?= $row['idproduct'] ?>/gallery/large/<?= $row['img']; ?>">
                            <img src="public/images/products/<?= $row['idproduct'] ?>/gallery/small/<?= $row['img']; ?>" style="width: 60px;">
                        </li>
                <?php }
                } ?>
    ...
    <div class="left">
        ...
        <div class="right">
            ...
            <div id="price">
                ...
                <span class="" style="font-size:11pt;text-decoration: line-through;">
                    <?= $productInfo['price']; ?>
                </span>
                <span class="" style="font-size: 9pt;">
                    تومان
            ...
            <div id="priceforyou">
                <span class="" style="font-size: 12.5pt;">
                    قیمت برای شما:
                </span>
                <span class="" style="font-size: 13.5pt;color:#0f0;">
            ...
            <div id="compare">
                <!--<span class=" compare_btn">
                        مقایسه کن
                    </span>-->
                <span style="cursor: pointer;" class=" addtocart_btn" onclick="addToBasket('<?= $productInfo['id'] ?>')">
                    <i></i>
                    افزودن به سبد
                </span>
